          ...
          <Card className={styles.welcome}>
            <Row justify='space-between'>
              <Col className={styles.name}>
                Hi Adam! <span className={styles.regular}>Good afternoon, today is your 100th day with this website.</span>
              </Col>
            </Row>
          </Card>
          <Card
          ...
          >
            <Row gutter={[16, 16]}>
              ...
              <Col span={3}>
                ...
                <div className={styles.value}>birdgang@wisc.edu</div>
              </Col>
            </Row>
            <Row gutter={[16, 16]}>
              <Col span={3}>
              ...
              <Col span={3}>
                ...
                <div className={styles.value}>2023-03-01</div>
              </Col>
            </Row>
          </Card>
