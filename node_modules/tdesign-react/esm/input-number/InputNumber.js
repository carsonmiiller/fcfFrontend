...
var InputNumber = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  return /* @__PURE__ */React.createElement("div", {
    ref: ref,
    className: classNames(className, inputClassName, commonClassNames.SIZE[size], (_classNames = {}, _defineProperty(_classNames, commonClassNames.STATUS.disabled, disabled), _defineProperty(_classNames, "".concat(classPrefix, "-is-controls-right"), theme === "column"), _defineProperty(_classNames, "".concat(inputClassName, "--").concat(theme), theme), _defineProperty(_classNames, "".concat(inputClassName, "--auto-width"), props.autoWidth), _classNames)),
    style: style,
    onBlur: handleBlur,
    onFocus: handleFocus,
