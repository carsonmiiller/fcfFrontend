...
var Menu = forwardRefWithStatics(function (props, ref) {
  ...
  return /* @__PURE__ */React.createElement(MenuContext.Provider, {
    ...
    ref: ref,
    className: classNames(className, "".concat(classPrefix, "-default-menu"), (_classNames = {}, _defineProperty(_classNames, "".concat(classPrefix, "-is-collapsed"), collapsed), _defineProperty(_classNames, "".concat(classPrefix, "-menu--dark"), theme === "dark"), _classNames)),
    style: _objectSpread({
