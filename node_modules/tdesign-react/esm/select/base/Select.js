...
var Select = forwardRefWithStatics(function (props, ref) {
  ...
  var _useState = useState(popupVisible || false),
  ...
  var onTagChange = function onTagChange(currentTags, context) {
  ...
  var handleChange = function handleChange(value2) {
    if (multiple) {
    ...
    onChange === null || onChange === void 0 ? void 0 : onChange(value2, null);
  };
  ...
  var handleInputChange = function handleInputChange(value2) {
    ...
    if (selectedLabel === value2) return;
