...
var _excluded = ["store", "dataSource", "formatTreeColumn"];
...
var EnhancedTable = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  var _useState = useState(store === null || store === void 0 ? void 0 : store.treeDataMap),
      _useState2 = _slicedToArray(_useState, 1),
      treeDataMap = _useState2[0];
  ...
  useImperativeHandle(ref, function () {
    return _objectSpread({}, treeInstanceFunctions);
  });
  ...
  return /* @__PURE__ */React.createElement(PrimaryTable, _objectSpread({}, primaryTableProps));
});
