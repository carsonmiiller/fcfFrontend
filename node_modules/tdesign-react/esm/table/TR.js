...
function renderCell(params) {
  ...
  return col.cell || col.render || get_1(row, col.colKey);
}
function TR(props) {
  var _props$columns;
  ...
  function renderEllipsisCell(cellParams, params) {
    ...
    return /* @__PURE__ */React.createElement(Ellipsis, {
      ...
      popupProps: _typeof(col.ellipsis) === "object" ? col.ellipsis : void 0
    }, cellNode);
  }
  ...
  function renderTd(params, extra) {
    ...
    var customClasses = isFunction_1(col.className) ? col.className(_objectSpread(_objectSpread({}, params), {}, {
      type: "td"
    })) : col.className;
  ...
  var columnVNodeList = (_props$columns = props.columns) === null || _props$columns === void 0 ? void 0 : _props$columns.map(function (col, colIndex) {
    ...
    if (isFunction_1(props.rowspanAndColspan)) {
