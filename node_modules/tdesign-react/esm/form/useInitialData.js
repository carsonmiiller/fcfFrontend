...
import { C as Checkbox, a as CheckboxGroup } from '../_chunks/dep-6a955d55.js';
...
function getDefaultInitialData(children, initialData) {
  var defaultInitialData = initialData;
  React.Children.forEach(children, function (child) {
    if (!child) return;

    if ( /*#__PURE__*/React.isValidElement(child) && typeof initialData === "undefined") {
