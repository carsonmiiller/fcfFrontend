...
function Jumper(props) {
  ...
  return /* @__PURE__ */React.createElement("div", {
    className: "".concat(classPrefix, "-jumper")
    ...
    onClick: function onClick() {
      return onJumperClick(-1);
    },
    icon: /* @__PURE__ */React.createElement(ChevronLeftIcon, null),
    className: "".concat(classPrefix, "-jumper__btn")
  }), /* @__PURE__ */React.createElement(Button, {
    title: currentTitle,
    variant: "text",
    size: size,
    shape: "square",
    onClick: function onClick() {
      return onJumperClick(0);
    },
    icon: /* @__PURE__ */React.createElement(RoundIcon, null),
    className: "".concat(classPrefix, "-jumper__btn")
  }), /* @__PURE__ */React.createElement(Button, {
    title: nextTitle,
    variant: "text",
