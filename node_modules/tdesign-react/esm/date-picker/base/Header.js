...
import Jumper from '../../common/Jumper.js';
...
var DatePickerHeader = function DatePickerHeader(props) {
  ...
  var showMonthPicker = mode === "date";

  function handlePanelTopClick(e) {
    var _e$nativeEvent;

    e.stopPropagation();
    e === null || e === void 0 ? void 0 : (_e$nativeEvent = e.nativeEvent) === null || _e$nativeEvent === void 0 ? void 0 : _e$nativeEvent.stopImmediatePropagation();
  ...
  return /* @__PURE__ */React.createElement("div", {
    ...
    popupProps: {
      attach: function attach(triggerNode) {
  ...
  })), /* @__PURE__ */React.createElement(Jumper, _objectSpread(_objectSpread({}, labelMap[mode]), {}, {
