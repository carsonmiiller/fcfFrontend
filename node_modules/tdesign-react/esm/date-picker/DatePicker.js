...
import DatePickerPanel from './panel/DatePickerPanel.js';
...
var DatePicker = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  var _useSingle = useSingle(props),
      ...
      timeValue = _useSingle.timeValue,
      ...
      setTimeValue = _useSingle.setTimeValue,
  ...
  function onCellClick(date) {
    ...
    if (enableTimePicker) {
      ...
      onChange(formatDate(date, "valueType"), {
  ...
  function onJumperClick(flag) {
    ...
    var nextInputValue = formatDate(dayjs(inputValue || new Date()).year(nextYear).month(nextMonth).toDate());
    setYear(nextYear);
    setMonth(nextMonth);
  ...
  function onConfirmClick() {
    ...
    if (nextValue) {
      onChange(formatDate(inputValue, "valueType"), {
  ...
  function onYearChange(year2) {
    setYear(year2);
    var nextDateObj = dayjs(inputValue || new Date(), format);
    if (nextDateObj) nextDateObj = dayjs(inputValue || new Date());
    var nextDate = nextDateObj.year(year2).toDate();
    setInputValue(formatDate(nextDate));
  ...
  function onMonthChange(month2) {
    ...
    var nextDateObj = dayjs(inputValue || new Date(), format);
    if (nextDateObj) nextDateObj = dayjs(inputValue || new Date());
    var nextDate = nextDateObj.month(month2).toDate();
    setInputValue(formatDate(nextDate));
    setCacheValue(formatDate(nextDate));
  }
  ...
  return /* @__PURE__ */React.createElement("div", {
    ...
    panel: /* @__PURE__ */React.createElement(DatePickerPanel, _objectSpread({}, panelProps))
  }));
});
