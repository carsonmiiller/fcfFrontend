...
var DatePickerPanel = function DatePickerPanel(props) {
  ...
  var tableData = useTableData(_objectSpread({
    ...
    month: month,
    mode: mode,
    start: value ? dayjs(value, format).toDate() : void 0,
  ...
  }, ["top", "left"].includes(presetsPlacement) ? /* @__PURE__ */React.createElement(ExtraContent, _objectSpread(_objectSpread({}, props), {}, {
    selectedValue: value
  })) : null, /* @__PURE__ */React.createElement(PanelContent, _objectSpread({
    tableData: tableData
  }, panelContentProps)), ["bottom", "right"].includes(presetsPlacement) ? /* @__PURE__ */React.createElement(ExtraContent, _objectSpread(_objectSpread({}, props), {}, {
    selectedValue: value
  })) : null);
};
