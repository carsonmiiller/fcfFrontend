...
var _excluded = ["disabled", "maxlength", "maxcharacter", "className", "readonly", "autofocus", "style", "onKeydown", "onKeypress", "onKeyup", "autosize", "status", "tips"];
...
var Textarea = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var _useState3 = React.useState({}),
      ...
      textareaStyle = _useState4[0],
      setTextareaStyle = _useState4[1];
  ...
  var characterLength = React.useMemo(function () {
    var characterInfo = _util_helper.getCharacterLength(String(value), maxcharacter);
  ...
  var textareaClassNames = classNames__default["default"](className, "".concat(classPrefix, "-textarea__inner"), (_classNames = {}, defineProperty._defineProperty(_classNames, "".concat(classPrefix, "-is-").concat(status), status), defineProperty._defineProperty(_classNames, "".concat(classPrefix, "-is-disabled"), disabled), defineProperty._defineProperty(_classNames, "".concat(classPrefix, "-is-focused"), isFocused), defineProperty._defineProperty(_classNames, "".concat(classPrefix, "-resize-none"), _typeof._typeof(autosize) === "object"), _classNames));
  ...
  function inputValueChangeHandle(e) {
    ...
    if (maxcharacter && maxcharacter >= 0) {
      var stringInfo = _util_helper.getCharacterLength(val, maxcharacter);
  ...
  return /* @__PURE__ */React__default["default"].createElement("div", {
    style: style,
    ref: wrapperRef,
    className: classNames__default["default"](className, "".concat(classPrefix, "-textarea"))
    ...
    className: "".concat(classPrefix, "-textarea__limit")
  }, "".concat(currentLength, "/").concat(maxlength)) : null, tips ? /* @__PURE__ */React__default["default"].createElement("div", {
