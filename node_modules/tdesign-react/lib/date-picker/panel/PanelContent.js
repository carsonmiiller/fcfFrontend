...
function PanelContent(props) {
  ...
  var _getDefaultFormat = datePicker_hooks_useFormat.getDefaultFormat({
    mode: mode,
    format: format,
  ...
  var defaultTimeValue = React.useMemo(function () {
    return dayjs__default["default"]().format(timeFormat);
  }, [timeValue]);
  return /* @__PURE__ */React__default["default"].createElement("div", {
    ...
    onJumperClick: function onJumperClick(val) {
      return _onJumperClick === null || _onJumperClick === void 0 ? void 0 : _onJumperClick(val, {
        partial: partial
      });
    }
    ...
    onCellClick: function onCellClick(date, _ref) {
      var e = _ref.e;
  ...
  }, timeValue || defaultTimeValue), /* @__PURE__ */React__default["default"].createElement(timePicker_panel_TimePickerPanel["default"], _objectSpread({
    format: timeFormat,
    value: timeValue,
