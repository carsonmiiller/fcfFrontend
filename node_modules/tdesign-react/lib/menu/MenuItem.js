...
var MenuItem = function MenuItem(props) {
  ...
  _util_useRipple["default"](menuItemRef);
  ...
  return /* @__PURE__ */React__default["default"].createElement("li", {
    ref: menuItemRef,
    className: classNames__default["default"](className, "".concat(classPrefix, "-menu__item"), (_classNames = {}, defineProperty._defineProperty(_classNames, "".concat(classPrefix, "-is-disabled"), disabled), defineProperty._defineProperty(_classNames, "".concat(classPrefix, "-is-active"), value === active), defineProperty._defineProperty(_classNames, "".concat(classPrefix, "-menu__item--plain"), !icon), _classNames)),
    style: _objectSpread({}, style),
    onClick: handleClick
  }, icon, href ? /* @__PURE__ */React__default["default"].createElement("a", {
    href: href,
    target: target,
    className: classNames__default["default"]("".concat(classPrefix, "-menu__item-link"))
