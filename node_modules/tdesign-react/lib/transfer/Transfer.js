...
var difference = require('../_chunks/dep-3b8bf060.js');
...
var Transfer = function Transfer(props) {
  ...
  var _getDefaultValue$map5 = transfer_utils.getDefaultValue(operation, [function () {
    return /* @__PURE__ */React__default["default"].createElement(tdesignIconsReact.ChevronRightIcon, null);
  }, function () {
    return /* @__PURE__ */React__default["default"].createElement(tdesignIconsReact.ChevronLeftIcon, null);
  }]).map(function (item) {
    return transfer_utils.getJSX(item);
  }),
