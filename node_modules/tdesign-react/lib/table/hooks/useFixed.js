...
function useFixed(props) {
  ...
  var _useState = React.useState(false),
      ...
      isFixedHeader = _useState2[0],
      setIsFixedHeader = _useState2[1];

  var _useState3 = React.useState(false),
      _useState4 = slicedToArray._slicedToArray(_useState3, 2),
      isWidthOverflow = _useState4[0],
      setIsWidthOverflow = _useState4[1];

  var affixHeaderRef = React.useRef();

  var _useState5 = React.useState(true),
      _useState6 = slicedToArray._slicedToArray(_useState5, 2),
      showAffixHeader = _useState6[0],
      setShowAffixHeader = _useState6[1];
  ...
  var _useState15 = React.useState(0),
      ...
      tableWidth = _useState16[0],
      setTableWidth = _useState16[1];

  var _useState17 = React.useState({}),
      _useState18 = slicedToArray._slicedToArray(_useState17, 2),
      thWidthList = _useState18[0],
      setThWidthList = _useState18[1];

  var _useState19 = React.useState(false),
      _useState20 = slicedToArray._slicedToArray(_useState19, 2),
      isFixedColumn = _useState20[0],
      setIsFixedColumn = _useState20[1];

  var _useState21 = React.useState(false),
      _useState22 = slicedToArray._slicedToArray(_useState21, 2),
      isFixedRightColumn = _useState22[0],
      setIsFixedRightColumn = _useState22[1];

  var notNeedThWidthList = React.useMemo(function () {
    return !(headerAffixedTop || (scroll === null || scroll === void 0 ? void 0 : scroll.type) === "virtual");
  ...
  var updateHeaderScroll = function updateHeaderScroll(target) {
    ...
    var newTarget = target || tableContentRef.current;
    ...
    if (affixHeaderRef) {
      ...
      affixHeaderRef.current.scrollLeft = left2;
    }
  };
  ...
  var updateThWidthList = function updateThWidthList(trList) {
    ...
    if (affixHeaderRef) {
      var left = tableContentRef.current.scrollLeft;
      lastScrollLeft = left;
  ...
  var updateThWidthListHandler = function updateThWidthListHandler() {
    ...
    var timer = setTimeout(function () {
      updateTableWidth();
      var thead = tableContentRef.current.querySelector("thead");
  ...
  React.useEffect(updateFixedColumnHandler, [isFixedColumn, columns, tableContentRef]);
