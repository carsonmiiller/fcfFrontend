...
var index = require('../_chunks/dep-75cfd7f6.js');
...
var _baseGet = require('../_chunks/dep-8a3a8f07.js');
var hasIn$1 = require('../_chunks/dep-c7b74e6e.js');
var _setToString = require('../_chunks/dep-9cacaf01.js');
var _cacheHas = require('../_chunks/dep-afd8013f.js');
var _typeof = require('../_chunks/dep-3405bda4.js');
var keysIn = require('../_chunks/dep-8a149e9f.js');
var _baseGetTag = require('../_chunks/dep-fcf32c81.js');
var eq$1 = require('../_chunks/dep-c40d75ac.js');
var _getAllKeys = require('../_chunks/dep-dfcfc710.js');
var _getTag = require('../_chunks/dep-029baf10.js');
var isArray$2 = require('../_chunks/dep-c90cc28f.js');
var isTypedArray$1 = require('../_chunks/dep-c72c7229.js');
var isObjectLike$1 = require('../_chunks/dep-b1a67107.js');
var isObject$1 = require('../_chunks/dep-15a4424e.js');
var get$1 = require('../_chunks/dep-3181fd9f.js');
var _baseProperty = require('../_chunks/dep-837b19c6.js');
var toInteger$1 = require('../_chunks/dep-d97f1281.js');
...
var upload_hooks_useSizeLimit = require('./hooks/useSizeLimit.js');
...
var identity$1 = _setToString.identity_1;
/**
...
var baseMatches = _baseMatches,
    ...
    identity = _setToString.identity_1,
...
var Upload = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var filesRef = React.useRef(fileList);
  ...
  var handleSizeLimit = upload_hooks_useSizeLimit["default"]();
  var handlePreviewImg = React.useCallback(function (file, event) {
  ...
  var multiUpdateFileList = function multiUpdateFileList(file) {
    ...
    var nextFileList = toConsumableArray._toConsumableArray(filesRef.current);
  ...
  var handleSuccess = React.useCallback(function (_ref2) {
    var e = _ref2.e,
        tmpFile = _ref2.file,
  ...
  var handleProgress = React.useCallback(function (_ref3) {
    var e = _ref3.e,
        file = _ref3.file,
  ...
  var upload = React.useCallback( /*#__PURE__*/function () {
    var _ref4 = index._asyncToGenerator( /*#__PURE__*/index.regenerator.mark(function _callee(uploadFile) {
      var file;
      return index.regenerator.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 10:
              file.xhr = _common_js_upload_xhr["default"]({
                method: method,
                action: action,
                data: data,
                file: file,
  ...
  var formatFiles = function formatFiles() {
    ...
    return files.map(function (fileRaw) {
      ...
      uploadFile.url = (_urlCreator = upload_util.urlCreator()) === null || _urlCreator === void 0 ? void 0 : _urlCreator.createObjectURL(fileRaw);
      return uploadFile;
    });
  };
  ...
  var handleBeforeUpload = function handleBeforeUpload(file) {
    ...
    if (sizeLimit) {
      var _handleSizeLimit = handleSizeLimit(file.size, sizeLimit),
          _handleSizeLimit2 = slicedToArray._slicedToArray(_handleSizeLimit, 2),
  ...
  var cancelUpload = React.useCallback(function () {
    var files = toConsumableArray._toConsumableArray(filesRef.current);
