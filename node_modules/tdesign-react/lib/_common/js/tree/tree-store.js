...
var createClass = require('../../../_chunks/dep-b8367f2e.js');
var difference = require('../../../_chunks/dep-3b8bf060.js');
var camelCase = require('../../../_chunks/dep-e3db5727.js');
var _baseRest = require('../../../_chunks/dep-910dcfa3.js');
  ...
  createClass._createClass(TreeStore, [{
    ...
    value: function getNodes(item, options) {
      ...
      if (options) {
        ...
        if (_baseRest.isPlainObject_1(conf.props)) {
          nodes = nodes.filter(function (node) {
