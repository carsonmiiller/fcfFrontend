...
var chunk = require('../../../_chunks/dep-e9185c09.js');
...
function getWeeks(_ref5, _ref6) {
  ...
  return chunk.chunk_1(daysArr, 7);
}
function getYears(year, _ref7) {
  ...
  return chunk.chunk_1(yearArr, 4);
}
function getMonths(year, params) {
  ...
  return chunk.chunk_1(MonthArr, 4);
}
function flagActive(data, _ref8) {
  var args = chunk._extends({}, _ref8);
