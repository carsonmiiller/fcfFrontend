...
function createContainer(_ref) {
  ...
  if (container.length < 1) {
    ...
    div.className = classNames__default["default"](tdMessageListClass, tdMessagePlacementClass);
    ...
    Object.keys(message_const.PlacementOffset[placement]).forEach(function (key) {
      div.style[key] = message_const.PlacementOffset[placement][key];
    });
...
function renderElement(theme, config) {
  ...
  var content = config.content,
      ...
      onDurationEnd = _config$onDurationEnd === void 0 ? _util_noop["default"] : _config$onDurationEnd;
  var div = document.createElement("div");
  keyIndex += 1;
  var message = {
  ...
  if (Array.isArray(offset) && offset.length === 2) {
    var _offset = slicedToArray._slicedToArray(offset, 2),
        left = _offset[0],
        top = _offset[1];
  ...
  return new Promise(function (resolve) {
    ReactDOM__default["default"].render( /* @__PURE__ */React__default["default"].createElement(message_MessageComponent["default"], _objectSpread({
      theme: theme,
      style: style,
      key: keyIndex
    }, config), content), div);
