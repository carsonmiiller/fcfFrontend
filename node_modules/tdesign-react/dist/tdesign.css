...
.t-table--striped:not(.t-table--header-fixed) tbody tr:nth-of-type(odd) {
  background-color: var(--td-bg-color-secondarycontainer);
}
...
.t-popup__reference.t-table__filter-icon {
  margin-top: -4px;
}
...
.t-table__double-icons .t-popup__reference {
  height: 16px;
}
...
.t-popup__reference .t-table__filter-icon,
.t-popup__reference .t-table__sort-icon {
  vertical-align: initial;
}
...
.t-table-td--ellipsis .t-popup__reference {
  width: 100%;
  display: inline;
}
.t-table__th-cell-inner > .t-popup__reference,
.t-table__cell--title > .t-popup__reference {
  width: 100%;
  display: inline;
  white-space: nowrap;
  word-wrap: normal;
...
.t-table--affixed-header .t-table__content th.t-table__cell--fixed-left-last::after,
.t-table--affixed-header .t-table__content th.t-table__cell--fixed-right-first::after {
  -webkit-box-shadow: none;
          box-shadow: none;
}
.t-table--affixed-footer .t-table__content th.t-table__cell--fixed-left-last::after,
.t-table--affixed-footer .t-table__content th.t-table__cell--fixed-right-first::after {
  -webkit-box-shadow: none;
          box-shadow: none;
}
...
.t-tree__item {
  ...
  -ms-flex-wrap: nowrap;
      flex-wrap: nowrap;
  padding: 0 0 0 calc(24px * var(--level) + 8px);
  cursor: default;
...
.t-tree__label {
  ...
  -webkit-box-flex: 0;
      -ms-flex: 0 0 auto;
          flex: 0 0 auto;
  margin: calc((42px - 28px) / 2) 0 calc((42px - 28px) / 2) 4px;
  padding: 0 4px;
  border-radius: 3px;
  cursor: pointer;
  -webkit-transition: background-color 0.24s cubic-bezier(0.38, 0, 0.24, 1);
...
@-webkit-keyframes t-tree-toggle {
  ...
  50% {
    opacity: 0;
    max-height: calc(42px * var(--hscale) + 0px);
  }
  100% {
    opacity: 1;
    max-height: calc(42px * var(--hscale) + 0px);
...
.range-input-disabled.t-range-input.t-is-disabled {
  color: var(--td-text-color-disabled);
  background-color: var(--td-bg-color-component-disabled);
}
.range-input-disabled.t-range-input.t-is-disabled:hover {
  border-color: var(--td-border-level-2-color);
}
.range-input-disabled.t-range-input.t-is-disabled .t-range-input__inner {
  cursor: not-allowed;
  color: var(--td-text-color-disabled);
}
.range-input-disabled.t-range-input.t-is-disabled .t-range-input__inner::-webkit-input-placeholder {
  color: var(--td-text-color-disabled);
}
.range-input-disabled.t-range-input.t-is-disabled .t-range-input__inner::-moz-placeholder {
  color: var(--td-text-color-disabled);
}
.range-input-disabled.t-range-input.t-is-disabled .t-range-input__inner:-ms-input-placeholder {
  color: var(--td-text-color-disabled);
}
.range-input-disabled.t-range-input.t-is-disabled .t-range-input__inner::-ms-input-placeholder {
  color: var(--td-text-color-disabled);
}
.range-input-disabled.t-range-input.t-is-disabled .t-range-input__inner::placeholder {
  color: var(--td-text-color-disabled);
}
.range-input-disabled.t-range-input.t-is-disabled > .t-range-input__prefix .t-icon,
.range-input-disabled.t-range-input.t-is-disabled > .t-range-input__suffix .t-icon {
  color: var(--td-text-color-disabled);
}
.t-range-input {
  width: -webkit-max-content;
...
.t-range-input.t-range-input.t-is-disabled {
  color: var(--td-text-color-disabled);
  background-color: var(--td-bg-color-component-disabled);
}
.t-range-input.t-range-input.t-is-disabled:hover {
  border-color: var(--td-border-level-2-color);
}
.t-range-input.t-range-input.t-is-disabled .t-range-input__inner {
  cursor: not-allowed;
  color: var(--td-text-color-disabled);
}
.t-range-input.t-range-input.t-is-disabled .t-range-input__inner::-webkit-input-placeholder {
  color: var(--td-text-color-disabled);
}
.t-range-input.t-range-input.t-is-disabled .t-range-input__inner::-moz-placeholder {
  color: var(--td-text-color-disabled);
}
.t-range-input.t-range-input.t-is-disabled .t-range-input__inner:-ms-input-placeholder {
  color: var(--td-text-color-disabled);
}
.t-range-input.t-range-input.t-is-disabled .t-range-input__inner::-ms-input-placeholder {
  color: var(--td-text-color-disabled);
}
.t-range-input.t-range-input.t-is-disabled .t-range-input__inner::placeholder {
  color: var(--td-text-color-disabled);
}
.t-range-input.t-range-input.t-is-disabled > .t-range-input__prefix .t-icon,
.t-range-input.t-range-input.t-is-disabled > .t-range-input__suffix .t-icon {
  color: var(--td-text-color-disabled);
}
.t-range-input.t-range-input--prefix > .t-range-input__prefix-icon {
  padding-right: 8px;
}
...
.t-range-input.t-range-input--suffix > .t-range-input__suffix-icon {
  padding-left: 8px;
}
...
.t-time-picker__group.t-is-focused .t-input__suffix .t-icon:not(.t-input__suffix-clear) {
  color: var(--td-brand-color);
}
...
.t-date-picker__panel-container,
.t-date-range-picker__panel-container {
  padding: 0;
  min-width: 280px;
}
.t-date-picker__panel-container .t-select__dropdown,
.t-date-range-picker__panel-container .t-select__dropdown {
  max-height: 160px;
}
...
.t-date-picker__header-controller--month {
  width: 80px;
}
...
.t-date-picker__table th {
  text-align: center;
  color: var(--td-text-color-secondary);
  font-weight: 400;
}
.t-date-picker__table td {
  text-align: center;
  font-weight: 500;
}
.t-date-picker__table thead::after {
  content: "-";
  display: block;
  line-height: 3px;
  color: transparent;
...
.t-date-picker__footer--left {
  ...
  -webkit-box-direction: normal;
      -ms-flex-direction: column;
          flex-direction: column;
  border-right: 1px solid var(--td-gray-color-3);
}
...
.t-date-picker__cell-inner {
  ...
  margin: 3px;
  border-radius: 3px;
  -webkit-transition: background-color 0.2s linear, border-color 0.2s linear, -webkit-box-shadow 0.2s cubic-bezier(0.38, 0, 0.24, 1);
  transition: background-color 0.2s linear, border-color 0.2s linear, -webkit-box-shadow 0.2s cubic-bezier(0.38, 0, 0.24, 1);
  transition: box-shadow 0.2s cubic-bezier(0.38, 0, 0.24, 1), background-color 0.2s linear, border-color 0.2s linear;
  transition: box-shadow 0.2s cubic-bezier(0.38, 0, 0.24, 1), background-color 0.2s linear, border-color 0.2s linear, -webkit-box-shadow 0.2s cubic-bezier(0.38, 0, 0.24, 1);
}
...
.t-date-picker__cell--hover-highlight + .t-date-picker__cell--hover-highlight::after {
  left: -28px;
}
.t-date-picker__cell--highlight + .t-date-picker__cell--highlight::before {
  left: -28px;
}
...
.t-card__title {
  font-size: 16px;
  font-family: PingFang SC, Microsoft YaHei, Arial Medium;
  color: var(--td-text-color-primary);
  margin-right: 8px;
  word-break: break-all;
}
