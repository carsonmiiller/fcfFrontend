...
import { m as merge_1 } from '../../_chunks/dep-e3ed7551.js';
import { f as flatten_1 } from '../../_chunks/dep-3cff266a.js';
...
function useInstance(props, formRef, formMapRef) {
  ...
  function validate(param) {
    ...
    var list = _toConsumableArray(formMapRef.current.values()).filter(function (formItemRef) {
      var _formItemRef$current, _formItemRef$current2;

      return isFunction_1((_formItemRef$current = formItemRef.current) === null || _formItemRef$current === void 0 ? void 0 : _formItemRef$current.validate) && needValidate((_formItemRef$current2 = formItemRef.current) === null || _formItemRef$current2 === void 0 ? void 0 : _formItemRef$current2.name, fields);
