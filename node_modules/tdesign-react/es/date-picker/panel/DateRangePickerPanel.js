...
var DateRangePickerPanel = function DateRangePickerPanel(props) {
  ...
  var _props$value = props.value,
      ...
      year = props.year,
      month = props.month,
      _props$timeValue = props.timeValue,
      timeValue = _props$timeValue === void 0 ? [] : _props$timeValue,
  ...
  var disableDateOptions = useDisableDate({
    ...
    mode: mode,
    format: format,
    start: isFirstValueSelected && activeIndex === 1 ? dayjs(value[0]).toDate() : void 0,
    end: isFirstValueSelected && activeIndex === 0 ? dayjs(value[1]).toDate() : void 0
  });
  ...
  var startTableData = useTableData(_objectSpread({
    isRange: true,
    start: value[0] ? dayjs(value[0]).toDate() : void 0,
    end: value[1] ? dayjs(value[1]).toDate() : void 0,
    hoverStart: hoverValue[0] ? dayjs(hoverValue[0]).toDate() : void 0,
    hoverEnd: hoverValue[1] ? dayjs(hoverValue[1]).toDate() : void 0,
    year: startYear,
    month: startMonth,
    mode: mode,
