...
function createFileURL(file) {
  ...
  return (_urlCreator = urlCreator()) === null || _urlCreator === void 0 ? void 0 : _urlCreator.createObjectURL(file);
}
...
export { abridgeName, createFileURL, finishUpload, getCurrentDate, isSingleFile, returnFileSize, urlCreator };
